...
<head>
    ...
    <title>Dicky Muhammad Yahya</title>
...
<header>
    <div class="container">
        <h1><a href="index.php" class="logo">Dicky Muhammad Yahya</a></h1>
        <ul>
            ...
            <li><a href="login.php">LOGIN</a></li><!-- Tambahkan baris ini -->
        </ul>
    </div>
</header>
    ...
    <section id="portfolio" class="portfolio">
        <div class="container">
            ...
            <!-- Tambahkan tautan untuk informasi kontak -->
            <p>Untuk informasi lebih lanjut, silakan <a href="kontak.php">hubungi kami</a>.</p>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="box">
            <div class="col-4">
                <h4>Address</h4>
                <p>Jl. Bung tomo, Sungai Keledang, Samarinda Sebrang</p>
            </div>
            <div class="col-4">
                <h4>Email</h4>
                <p><a href="contact.html">dickymyahya@gmail.com</a></p>
            </div>
            <div class="col-4">
                <h4>Phone</h4>
                <p>(021) 0123456789</p>
            ...
            <div class="col-4">
                <h4>Mobile</h4>
                <p><a href="contact.html">081256977124</a></p>
            </div>
        </div>
    ...
    <footer>
        <div class="container">
            <small>Copyright &copy; 2023 - Dicky Muhammad Yahya. All Rights Reserved.</small>
        </div>
    </footer>
